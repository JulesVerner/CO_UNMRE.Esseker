GRAD_introCam_shotDefinitions = [
    ["CAMERA", 5, outroCam_pos_1, missionNamespace getVariable ["outroGuy", objNull], .6, true, false],
    ["CAMERA", 0, outroCam_pos_2, {missionNamespace getVariable ["outroVTOL", objNull]}, .6],
    ["MOVE", 30, outroCam_pos_3, {missionNamespace getVariable ["outroVTOL", objNull]}, .6],
    ["ATTACH", 10, {missionNamespace getVariable ["outroVTOL", objNull]}, {missionNamespace getVariable ["outroVTOLhelper", objNull]}, 1.2]
];
